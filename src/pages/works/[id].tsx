          ...
          <Slider {...settings}>
            ...
            {work.videos.map((video, index) => (
              <div className="overflow-hidden rounded-xl" key={index}>
                <video
                  autoPlay // This will make the video play automatically
                  muted // Muted is necessary for autoplay in most browsers
                ...
                >
                  <source src={video} type="video/mp4" /> {/* Adjust type if needed */}
